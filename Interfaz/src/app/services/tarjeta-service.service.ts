...
export class TarjetaServiceService {
  ...
  putNrcMatrimonios(id:string, nacionalidad: string, registro:Nrc_Matrimonios):Observable<any>{
    // console.log('llegue al servicio 09 forzar subir', registro);

    return this.http.put<any>(this.myAppUrl_NRC_Matrimonios + this.myApiUrl_NRC_Matrimonios + id + `/${nacionalidad}`, registro);
